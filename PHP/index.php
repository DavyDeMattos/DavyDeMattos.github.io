...
<div class="container--text--resume">
    ...
    <div class="text--cloud">
        <p>
            ...
            le développement. Dans le but d'obtenir les compétences nécessaire, j'ai décidé de suivre une formation chez O'clock, formation de niveau bac +2 (798 heures).
        </p>
        <p>
            J'y ai continué d'approfondir mon travail d'équipe ainsi que la résolution de défis techniques dans cette formation.
        </p>
        <p>
            Vous trouverez sur ce portfolio tous les projets (plus ou moins important) sur lesquels j'ai travaillé en espérant que cela vous donne envie de travailler ensemble.
        </p>
    </div>
</div>
<div>
